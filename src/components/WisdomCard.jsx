...
export default function WisdomCard() {
  const guidelines = [
    ...
    { id: 3, text: "Maintain discipline and chant 'Har Har Mahadev' in queue." },
    { id: 4, text: "Contact helpdesks for medical emergencies immediately." }
  ];

  return (
    <div className="w-[288px] shrink-0 flex flex-col gap-6">
      ...
      {/* Main Card */}
      <div className="bg-brand-primary-dark text-white rounded-2xl p-6 flex flex-col gap-6 shadow-lg border border-brand-primary-border/10 relative overflow-hidden">
        
        {/* Decorative Quote Icon Background */}
        <Quote size={80} className="absolute -right-4 -bottom-4 text-brand-primary/15 pointer-events-none transform -rotate-12" />

        {/* Wisdom Header */}
        <div className="flex items-center gap-2 text-saffron">
          <BookOpen size={18} />
          <span className="font-sans font-bold text-xs uppercase tracking-wider">Daily Wisdom</span>
        </div>
        ...
        <div className="text-left flex flex-col gap-3">
          <p className="font-sans italic text-sm text-brand-primary-light/95 leading-relaxed">
            ...
            शिव पादोदकं पीत्वा पुनर्जन्म न विद्यते ॥"
          </p>
        ...
        <div className="bg-brand-primary/30 border border-brand-primary-border/15 p-3.5 rounded-xl text-left mt-2">
          ...
          <p className="text-[9px] text-brand-primary-light/75 leading-tight">
            Dial toll-free helpline number 1800-XX-XXXX for immediate Yatra support.
          </p>
        </div>
