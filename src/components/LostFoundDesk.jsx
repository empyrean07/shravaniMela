...
export default function LostFoundDesk() {
  ...
  const desks = [
    {
      id: 1,
      name: "Sultanganj Ghat Lost & Found Desk",
      milestone: "Sultanganj",
      km: 0.5,
      lat: 25.2476,
      lon: 86.7381,
      announcements: "Active PA System",
      officers: "3 Desk Staff",
      status: "Active",
      ref: "Sultanganj Main Ghat Entrance",
    },
    {
      id: 2,
      name: "Katoria Central Shivir Helpdesk",
      milestone: "Katoria",
      km: 64.0,
      lat: 24.8194,
      lon: 86.7214,
      announcements: "PA & Screen Display",
      officers: "2 Desk Staff",
      status: "Active",
      ref: "Transit Rest Camp 3",
    },
    {
      id: 3,
      name: "Dharamsala Border Crossing Helpdesk",
      milestone: "Dharamsala",
      km: 88.5,
      lat: 24.6033,
      lon: 86.6719,
      announcements: "Bilingual PA System",
      officers: "2 Desk Staff",
      status: "Active",
      ref: "Dharamsala Border Post",
    },
    {
      id: 4,
      name: "Deoghar Temple Main Lost & Found Office",
      milestone: "Deoghar",
      km: 106.2,
      lat: 24.481,
      lon: 86.702,
      announcements: "24/7 Mega PA & Live Registry",
      officers: "8 Desk Staff",
      status: "Active",
      ref: "Near Temple Administrative Block",
    },
  ];
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-secondary font-medium mt-0.5">
            Registry assistance, loudspeaker announcement systems and helper
            desks.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 text-left relative z-10">
          ...
          <p className="text-teal-300 font-bold text-sm md:text-base mb-4 flex items-center gap-1.5">
            ...
            <span className="text-brand-primary-light/65 font-medium text-xs">
              ({activeDesk.milestone} - KM {activeDesk.km})
            </span>
          </p>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-brand-primary-border/15 pb-4">
          <div>
            ...
            <p className="text-xs text-neutral-secondary mt-1">
              Geographical location coordinates of the selected Lost & Found
              assistance desk.
            </p>
          </div>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {desks.map((desk, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center ${selectedDesk === index ? "bg-teal-500 text-white" : "bg-teal-50 text-teal-500"}`}
                >
                  <Search size={18} />
                </div>
