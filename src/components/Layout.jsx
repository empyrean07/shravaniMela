    ...
    return [
      {
        ...
        message: "Baba Temple Gate 3 is experiencing an extremely high volume of devotees. Consider using Gate 1 or Gate 5 for faster queue entry.",
        time: "10 mins ago",
        type: "alert",
        unread: true,
      ...
      },
      {
        ...
        message: "Langar post #12 at Katoria is currently serving hot meals and fresh water to all registered Yatris.",
        time: "45 mins ago",
        type: "success",
        unread: true,
      ...
      },
      {
        ...
        message: "Expect light rain showers in the Deoghar area by 4:00 PM. Yatris are advised to carry water-resistant gear and stay hydrated.",
        time: "2 hours ago",
        type: "info",
        unread: false,
      ...
      },
      {
        ...
        message: "A specialized trauma recovery post with 10 emergency beds and cardiac support is now operational at KM 64 (Katoria path).",
        time: "5 hours ago",
        type: "info",
        unread: false,
      ...
      },
      {
        ...
        message: "Indian Railways has announced 4 extra special trains running daily between Sultanganj and Deoghar stations starting today.",
        time: "1 day ago",
        type: "update",
        unread: false,
      ...
      },
      {
        ...
        message: "Devotees must carry their printed digital registration slip or download the digital barcode pass on their mobile phones for quick verification.",
        time: "2 days ago",
        type: "alert",
        unread: false,
  ...
  return (
    <div className="relative flex h-screen w-screen overflow-hidden bg-neutral-bg text-neutral-dark font-sans antialiased">
      ...
      >
        ...
        <span className="relative z-10 font-action font-black text-[10px] tracking-wider uppercase mt-0.5 text-white">SOS</span>
      </a>
    </div>
  );
}
