...
export default function FreeFood() {
  ...
  const langars = [
    {
      id: 1,
      name: "Sultanganj Sewa Shivir Langar",
      milestone: "Sultanganj",
      km: 0.5,
      lat: 25.245,
      lon: 86.735,
      menu: "Khichdi Prasad, Tea & Water",
      organization: "Sultanganj Yatra Samiti",
      status: "Active",
      ref: "Near Ghat Path Entrance",
    },
    {
      id: 2,
      name: "Katoria Sand Pathway Langar",
      milestone: "Katoria",
      km: 64.0,
      lat: 24.8,
      lon: 86.72,
      menu: "Roti, Dal, Sabzi & Halwa",
      organization: "Delhi Bol Bam Sewa Dal",
      status: "Active",
      ref: "Middle of Hilly Pathway",
    },
    {
      id: 3,
      name: "Dharamsala Border Langar Post",
      milestone: "Dharamsala",
      km: 88.5,
      lat: 24.6033,
      lon: 86.6719,
      menu: "Rice, Dal, Kheer & Puri",
      organization: "Jharkhand Sewa Trust",
      status: "Active",
      ref: "Near border security check",
    },
    {
      id: 4,
      name: "Deoghar Baba Dham Langar Hub",
      milestone: "Deoghar",
      km: 104.8,
      lat: 24.49,
      lon: 86.705,
      menu: "Sattvik Meals, Fruits & Milk",
      organization: "Baidyanath Shrine Board",
      status: "Active",
      ref: "KM 104.8 Rest Zone",
    },
  ];
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-secondary font-medium mt-0.5">
            Round-the-clock free hygienic vegetarian food served to all
            registered pilgrims.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 text-left relative z-10">
          ...
          <p className="text-emerald-300 font-bold text-sm md:text-base mb-4 flex items-center gap-1.5">
            ...
            <span className="text-emerald-300 font-bold">
              ({activeLangar.lat}, {activeLangar.lon})
            </span>
            <span className="text-brand-primary-light/65 font-medium text-xs">
              ({activeLangar.milestone} - KM {activeLangar.km})
            </span>
          </p>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-brand-primary-border/15 pb-4">
          <div>
            ...
            <p className="text-xs text-neutral-secondary mt-1">
              Geographical location coordinates of the selected Langar
              distribution point.
            </p>
          </div>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {langars.map((langar, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center ${selectedLangar === index ? "bg-emerald-50 text-white" : "bg-emerald-50 text-emerald-500"}`}
                >
                  <Utensils size={18} />
                </div>
