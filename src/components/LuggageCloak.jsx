...
export default function LuggageCloak() {
  ...
  const rooms = [
    {
      id: 1,
      name: "Sultanganj Station Cloak Room",
      milestone: "Sultanganj",
      km: 0.1,
      lat: 25.2415,
      lon: 86.7305,
      capacity: "800 Lockers",
      system: "Barcode Tracked",
      status: "Active",
      ref: "Near Sultanganj Platform 1 Entrance",
    },
    {
      id: 2,
      name: "Katoria Camp 2 Locker Service",
      milestone: "Katoria",
      km: 64.0,
      lat: 24.8194,
      lon: 86.7214,
      capacity: "400 Lockers",
      system: "Manual Token",
      status: "Active",
      ref: "Trauma Center compound",
    },
    {
      id: 3,
      name: "Deoghar Sadar Cloak Room",
      milestone: "Deoghar",
      km: 106.0,
      lat: 24.4819,
      lon: 86.7029,
      capacity: "1200 Lockers",
      system: "Barcode Tracked",
      status: "Active",
      ref: "Sadar Hospital Rest Area",
    },
    {
      id: 4,
      name: "Deoghar Q-Complex Mega Locker",
      milestone: "Deoghar",
      km: 105.5,
      lat: 24.485,
      lon: 86.704,
      capacity: "3000 Lockers",
      system: "Digital App Integrated",
      status: "Active",
      ref: "Inside Queue Complex Gate A",
    },
  ];
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-secondary font-medium mt-0.5">
            Barcode-tracked safety locker rooms to deposit baggage securely
            during Darshan.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 text-left relative z-10">
          ...
          <p className="text-violet-300 font-bold text-sm md:text-base mb-4 flex items-center gap-1.5">
            ...
            <span className="text-brand-primary-light/65 font-medium text-xs">
              ({activeRoom.milestone} - KM {activeRoom.km})
            </span>
          </p>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-brand-primary-border/15 pb-4">
          <div>
            ...
            <p className="text-xs text-neutral-secondary mt-1">
              Geographical location coordinates of the selected luggage cloak
              room.
            </p>
          </div>
          <a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {rooms.map((r, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center ${selectedRoom === index ? "bg-violet-500 text-white" : "bg-violet-50 text-violet-500"}`}
                >
                  <Briefcase size={18} />
                </div>
